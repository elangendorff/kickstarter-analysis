...
- Low-goal plays are far, far more frequent than high-goal plays. (See the "Analysis of Outcomes Based on Goals" section, above.) For some statistics: the goal values have a median of 5,000 and a mean of 6,124 — a notable right skew to the data.
